...
for(Cookie c:cs){
 ...
 String u=c.getValue();
  ...
  <tr>
    ...
    <td width="100" rowspan="3" valign="top"><img src="<s:url action="showMyPic1?id=%{loginid}"/>" height="100" width="100" /></td>
  </tr>
 ...
 <%-- <tr>
  ...
  <tr>
   <object data=" <s:url id="fileDownload" namespace="/" action="showMyResume1?id=%{loginid}"></s:url>" />
 ...
 <s:url id="deleteUrl" action="updatejobseeker">
